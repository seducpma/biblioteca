...
ActiveRecord::Schema.define(:version => 20130214132523) do
  ...
  create_table "temp_alunos", :force => true do |t|
    t.string   "nome"
    t.integer  "ra"
    t.string   "classe"
    t.integer  "ano_letivo"
  ...
  add_index "users", ["login", "email"], :name => "teste_login_email"
  add_index "users", ["login"], :name => "index_users_on_login", :unique => true
  add_index "users", ["login"], :name => "teste_login"
